...
test("cockpit resources identify local projects while unmigrated sources remain Supabase legacy", () => {
  ...
  assert.equal(resources.providers.source, "supabase:model_providers");
